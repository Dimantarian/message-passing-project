...
class Connection extends Component {
  ...
  getConnections = (personId) => {
    if (personId) {
      // TODO: endpoint should be abstracted into a config variable x
      fetch(
        `http://localhost:30007/api/persons/${personId}/connection?start_date=2020-01-01&end_date=2022-12-30&distance=5`
        // `http://udaconnect-api-connection:5000/api/persons/${personId}/connection?start_date=2020-01-01&end_date=2020-12-30&distance=5`
      )
